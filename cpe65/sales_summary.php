...
<head>
    ...
    <style> 
        ...
        /* === โค้ดที่แก้ไข (กำหนดความกว้างเฉพาะ .content-wrapper) === */
        .content-wrapper {
            max-width: 1400px; /* กำหนดความกว้างสูงสุดให้แคบลง */
            margin-left: auto;  /* จัดให้อยู่กึ่งกลาง */
            margin-right: auto; /* จัดให้อยู่กึ่งกลาง */
        }
        /* === จบส่วนที่แก้ไข === */
